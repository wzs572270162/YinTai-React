...
export default class Shopping extends Component {
    ...
    componentDidMount(){
        ...
        //                 if(checkedboxs_all.checked!==null && num.length==this.state.shuju.length){
        //                     return checkedboxs_all.checked=!checkedboxs_all.checked
        //                }
        //             }
        //         });
        
        // console.log(checkedboxs_all)
        // console.log(checkedboxs_all.checked)
        // if(checkedboxs_all.checked!==null && num.length==this.state.shuju.length){
        //      console.log(1111)
        //      return checkedboxs_all.checked=!checkedboxs_all.checked
        // }
                                ...
                                this.state.shuju.map(item=>{
                                    return (
                                        <div className="shopping_list" key={item._id}>
                                            <div><input type="checkbox" className="checkbox" onClick={this.activestate.bind(this)}/></div>
